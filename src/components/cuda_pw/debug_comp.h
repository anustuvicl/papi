...
#define TIMEDBG(...)
    ...
    #define THR_INFO fprintf(stderr, "THR %lu: ", (_papi_hwi_thread_id_fn != NULL) ? _papi_hwi_thread_id_fn() : 0);
        ...
        do { \
            ANSIBLUE \
            fprintf(stderr, "COMPDEBUG: %s: %s: %d: ", __FILE__, __func__, __LINE__); \
            THR_INFO;  \
    ...
    do { \
        ANSIMAGENTA;  \
        fprintf(stderr, "LOCK: %s: %s: %d: ", __FILE__, __func__, __LINE__); \
        THR_INFO;  \
        fprintf(stderr, __VA_ARGS__);  \
        ANSIEND;  \
    } while (0);
    ...
    do { \
        ...
        do { \
            ANSIGREEN  \
            fprintf(stderr, "CUDACALL: %s: %s: %d: ", __FILE__, __func__, __LINE__); \
            THR_INFO;  \
            fprintf(stderr, __VA_ARGS__);  \
            ANSIEND  \
        } while (0);
        ...
        do { \
            ANSIYELLOW;  \
            fprintf(stderr, "CUPTICALL: %s: %s: %d: ", __FILE__, __func__, __LINE__); \
            THR_INFO;  \
            fprintf(stderr, __VA_ARGS__);  \
            ANSIEND  \
        } while (0);
